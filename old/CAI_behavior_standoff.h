...
protected:
	...
	void OnChangeActiveWeapon( CBaseEntity *pOldWeapon, CBaseEntity *pNewWeapon );
...
public:
	...
	void		SetParameters( const AI_StandoffParams_t &params, CE_AI_GoalEntity *pGoalEntity = NULL );
...
protected:
	...
	bool		IsValidCover( const Vector &vecCoverLocation, CBaseEntity const *pHint );
	bool		IsValidShootPosition( const Vector &vecCoverLocation, CAI_Node *pNode, CBaseEntity const *pHint );
