...
public:
	...
	bool				IsLockedBy( CEntity *pNPC );	// Whether this node is available for use.
	...
	void				NPCStartedUsing( CAI_NPC *pNPC );
	void				NPCStoppedUsing( CAI_NPC *pNPC );
