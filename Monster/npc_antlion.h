#ifndef _INCLUDE_NPC_ANTLION_H_
#define _INCLUDE_NPC_ANTLION_H_
...
{
public:
	CE_DECLARE_CLASS( CNPC_Antlion, CAI_BaseAntlionBase );
	...
	bool		FInViewCone_Entity( CBaseEntity *pEntity );
	bool		FInViewCone_Vector( const Vector &vecSpot );
	...
	bool		HandleInteraction( int interactionType, void *data, CBaseEntity *sender = NULL );
...
private:
	...
	inline CEntity		*EntityToWatch( void );
	...
	bool	IsUnusableNode(int iNodeID, CBaseEntity *pHint);
	...
	CFakeHandle	m_hFightGoalTarget;
...
extern bool IsAntlionWorker( CEntity *pEntity );
