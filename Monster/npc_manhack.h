#ifndef _INCLUDE_NPC_MANHACK_H_
#define _INCLUDE_NPC_MANHACK_H_
...
public:
	...
	void			Event_Dying(CTakeDamageInfo const& info);
	...
	void			CrashTouch( CEntity *pOther );
	...
	void			Slice( CEntity *pHitEntity, float flInterval, trace_t &tr );
	void			Bump( CEntity *pHitEntity, float flInterval, trace_t &tr );
	void			Splash( const Vector &vecSplashPos );

	float			ManhackMaxSpeed( void );
	virtual void	VPhysicsShadowCollision( int index, gamevcollisionevent_t *pEvent );
	void			VPhysicsCollision( int index, gamevcollisionevent_t *pEvent );
	void			HitPhysicsObject( CEntity *pOther );
	...
	virtual bool	CanInteractWith( CAI_NPC *pUser ) { return false; } // Disabled for now (sjb)
...
private:
	...
	bool IsInEffectiveTargetZone( CEntity *pTarget );
	...
	void ComputeSliceBounceVelocity( CEntity *pHitEntity, trace_t &tr );
	...
	// physics influence
	CFakeHandle		m_hPhysicsAttacker;
	...
	CE_CSprite			*m_pEyeGlow;
	CE_CSprite			*m_pLightGlow;
	
	CSmokeTrail			*m_hSmokeTrail;
