...
*/
	...
	void Use( CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value )
	{
		...
		if ( pPlayer )
		{
			pPlayer->PickupObject( BaseEntity(), false );
		}
	}
...
protected:
	...
	CEFakeHandle<CCombatCharacter> m_hLastNPCToKickMe;		// Stores the last NPC who tried to knock me over
	...
	CEFakeHandle<CE_CSprite>			m_hEyeGlow;
	CEFakeHandle<CE_CBeam>				m_hLaser;
	CEFakeHandle<CTurretTipController>	m_pMotionController;
...
class CTurretTipController : public CE_InfoTarget_Fix, public IMotionEvent
{
public:
	CE_DECLARE_CLASS( CTurretTipController, CE_InfoTarget_Fix );
	DECLARE_DATADESC();
